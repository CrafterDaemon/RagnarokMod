...
namespace RagnarokMod.ILEditing
{
    public class MiscEdits : ModSystem
    {
        ...
        public override void OnModLoad(){
			On_SoundEngine.PlaySound_refSoundStyle_Nullable1_SoundUpdateCallback +=
			(On_SoundEngine.orig_PlaySound_refSoundStyle_Nullable1_SoundUpdateCallback orig, ref SoundStyle style, Vector2? position, SoundUpdateCallback callback) =>
			{
