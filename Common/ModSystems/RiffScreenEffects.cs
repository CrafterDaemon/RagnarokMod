    ...
    public class RiffScreenEffects : ModSystem
    {
        ...
        public override void OnModLoad()
        {
            tints = new List<RiffTint>
            {
                ...
                new RiffTint
                {
                    RiffType = RiffLoader.RiffType<ToxicWavesRiff>(),
                    MaxIntensity = 0.25f,
                    FadeSpeed = 0.006f,
        ...
        private static bool DrawToxicWavesTint(float intensity, SpriteBatch sb, Texture2D pixel, Rectangle screen, Rectangle src, float time)
        {
            // Sickly green base tint
            sb.Draw(pixel, screen, src, new Color(30, 80, 20) * intensity * 0.4f);
            ...
            for (int layer = 0; layer < 3; layer++)
            {
                ...
                Color toxicColor = new Color(60, 130, 40) * layerAlpha;
            ...
            // Breathing toxic yellow overlay
