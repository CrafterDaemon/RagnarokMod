        ...
        public override bool PreAI(NPC npc)
        {
            ...
            if (CalamityGamemodeCheck.isBossrush)
            {
                ...
                if (timer >= 180)
                {
                    ...
                    for (int i = 0; i < 10; i++)
                    {
                        int num = Dust.NewDust(npc.position, npc.width, npc.height, DustID.MushroomSpray, Terraria.Utils.NextFloat(Main.rand, -3f, 3f), Terraria.Utils.NextFloat(Main.rand, -3f, 3f), 0, default(Color), 1f);
                        Main.dust[num].noGravity = true;
                    }
                }
                int num2 = Dust.NewDust(new Vector2(npc.position.X, npc.position.Y) - npc.velocity, npc.width, npc.height, DustID.MushroomSpray, 0f, 0f, 150, default(Color), 1.25f);
                Dust dust = Main.dust[num2];
                Main.dust[num2].velocity *= 0f;
                Main.dust[num2].noGravity = true;
                int num3 = Dust.NewDust(new Vector2(npc.position.X, npc.position.Y) - npc.velocity, npc.width, npc.height, DustID.ShadowbeamStaff, 0f, 0f, 150, default(Color), 1.25f);
