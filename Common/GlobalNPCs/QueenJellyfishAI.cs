    ...
    public class QueenJellyfishAI : GlobalNPC
    {
        ...
        public override void FindFrame(NPC npc, int frameHeight)
        {
            if ((CalamityGamemodeCheck.isBossrush || CalamityGamemodeCheck.isRevengeance) && OtherModsCompat.shouldRagnarokBossAILoad(ModContent.GetInstance<BossConfig>().jelly))
            {
                if (whirlPoolTimer < 60)
                {
                    ...
                    if (counting >= 8 && counting < 16)
                    {
                        counter = 1;
                        diverOffset = 6;
                    }
                    if (counting >= 16 && counting < 24)
                    {
                        counter = 2;
                        diverOffset = 6;
                    }
                    if (counting >= 24 && counting < 32)
                    {
                        counter = 3;
                        diverOffset = 0;
                    }
                    if (counting >= 32 && counting < 40)
                    {
                        counter = 4;
                        diverOffset = -10;
                    }
                    if (counting >= 40 && counting < 48)
                    {
                        counter = 5;
                        diverOffset = -10;
                    }
                    if (counting >= 48 && counting < 56)
                    {
                        counter = 6;
                        diverOffset = 0;
                    }
                    if (counting >= 56 && counting < 64)
                    {
                        counter = 7;
                        diverOffset = 6;
                    }
        ...
        public override void PostDraw(NPC npc, SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            if ((CalamityGamemodeCheck.isBossrush || CalamityGamemodeCheck.isRevengeance) && OtherModsCompat.shouldRagnarokBossAILoad(ModContent.GetInstance<BossConfig>().jelly))
            {
                ...
                {
                    center = new Vector2(npc.Center.X, npc.Center.Y + 14f);
                }
                ...
                Vector2 vector2;
                vector2 = new Vector2((float)(value.Width / 2), (float)(value.Height / 2 / Main.npcFrameCount[npc.type] + 46));
                spriteBatch.Draw(value, vector, null, drawColor, npc.rotation, vector2, npc.scale, spriteEffects, 0f);
            }
        }
            ...
            if (CalamityGamemodeCheck.isBossrush)
            {
                ...
                if (whirlPoolTimer < 90)
                {
                    if (spawnType > 0)
                    {
                        if (npc.ai[0] >= 0f)
                        {
                            ...
                            if (num < 3 && Main.netMode != NetmodeID.MultiplayerClient)
                            {
                                ...
                                if (num2 < Main.maxNPCs && Main.netMode == NetmodeID.Server)
                                {
                        ...
                        if (spawnType > 1)
                        {
                            if (npc.ai[1] >= 0f)
                            {
                                ...
                                if (num3 < 3 && Main.netMode != NetmodeID.MultiplayerClient)
                                {
                                    ...
                                    if (num4 < Main.maxNPCs && Main.netMode == NetmodeID.Server)
                                    {
                                        NetMessage.SendData(MessageID.SyncNPC, -1, -1, null, num4, 0f, 0f, 0f, 0, 0, 0);
                                    }
                            ...
                            if (spawnType > 2 && npc.ai[2] >= 0f)
                            {
                                ...
                                if (num5 < 3 && Main.netMode != NetmodeID.MultiplayerClient)
                                {
                                    ...
                                    if (num6 < Main.maxNPCs && Main.netMode == NetmodeID.Server)
                                    {
                                        NetMessage.SendData(MessageID.SyncNPC, -1, -1, null, num6, 0f, 0f, 0f, 0, 0, 0);
                                    }
                ...
                if ((double)npc.life < (double)npc.lifeMax * 0.4)
                {
                    ...
                    if (whirlPoolTimer > 0 && whirlPoolTimer < 89)
                    {
                        ...
                        for (int l = 0; l < 5; l++)
                        {
                            int num7 = Dust.NewDust(npc.position, npc.width, npc.height + 550, DustID.WaterCandle, 0f, -8f, 100, default(Color), 3f);
                    ...
                    if (whirlPoolTimer == 540 && Main.netMode != NetmodeID.Server)
                    {
                ...
                if (whirlPoolTimer < 60)
                {
                    if (spawnType > 0)
                    {
                        if (npc.ai[0] >= 0f)
                        {
                            ...
                            if (num < 4 && Main.netMode != NetmodeID.MultiplayerClient) // Can spawn up to 4 instead
                            {
                                int num2 = NPC.NewNPC(source_FromAI, (int)npc.Center.X, (int)npc.Center.Y - 10, ModContent.NPCType<ZealousJellyfish>(), 0, (float)npc.whoAmI, 0f, 0f, 0f, 255);
                                if (num2 < Main.maxNPCs && Main.netMode == NetmodeID.Server)
                                {
                        ...
                        if (spawnType > 1)
                        {
                            if (npc.ai[1] >= 0f)
                            {
                                ...
                                if (num3 < 4 && Main.netMode != NetmodeID.MultiplayerClient) //Can spawn up to 4 instead
                                {
                                    int num4 = NPC.NewNPC(source_FromAI, (int)npc.Center.X, (int)npc.Center.Y - 10, ModContent.NPCType<SpittingJellyfish>(), 0, (float)npc.whoAmI, 0f, 0f, 0f, 255);
                                    if (num4 < Main.maxNPCs && Main.netMode == NetmodeID.Server)
                                    {
                            ...
                            if (spawnType > 2 && npc.ai[2] >= 0f)
                            {
                                ...
                                if (num5 < 4 && Main.netMode != NetmodeID.MultiplayerClient)    //Can spawn up to 4 instead
                                {
                                    int num6 = NPC.NewNPC(source_FromAI, (int)npc.Center.X, (int)npc.Center.Y - 10, ModContent.NPCType<DistractingJellyfish>(), 0, (float)npc.whoAmI, 0f, 0f, 0f, 255);
                                    if (num6 < Main.maxNPCs && Main.netMode == NetmodeID.Server)
                                    {
