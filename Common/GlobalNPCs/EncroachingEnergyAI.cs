    ...
    public class EncroachingEnergyAI : GlobalNPC
    {
        ...
        public override bool PreAI(NPC npc)
        {
            ...
            if (CalamityGamemodeCheck.isBossrush)
            {
                ...
                int dust_type = Dust.NewDust(new Vector2(npc.position.X, npc.position.Y) - npc.velocity * 0.5f, npc.width, npc.height, DustID.MagicMirror, 0f, 0f, 100, default(Color), 1f);
