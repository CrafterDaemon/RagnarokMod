...
namespace RagnarokMod.Items.BardItems.CalamityOverrides
{
    ...
    public class BelchingSaxophoneOverride : BardItem, ILocalizedModType{
        ...
        public override void SetStaticDefaults(){
            ...
            Empowerments.AddInfo<ResourceRegen>(5);
        }
        ...
        public override void SetBardDefaults(){
            ...
            Item.autoReuse = true;
            Item.shoot = ModContent.ProjectileType<AcidicReedOverride>();
            Item.shootSpeed = 20f;
        ...
        public override bool BardShoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback){
            ...
            if (Main.rand.NextBool()){
                ...
                Projectile.NewProjectile(source, position, speed, ModContent.ProjectileType<AcidicSaxBubbleOverride>(), damage, knockback, player.whoAmI);
            }
            ...
            if (Main.rand.NextBool()){
                int noteProj = Terraria.Utils.SelectRandom(Main.rand, new int[]{
