...
namespace RagnarokMod.Projectiles.HealerPro.Other
{
    public class VerdurantBloomPro : ModProjectile, ILocalizedModType
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                int index2 = Dust.NewDust(((Entity)this.Projectile).position, ((Entity)this.Projectile).width, ((Entity)this.Projectile).height, DustID.Wraith, (float)Main.rand.Next(-2, 2), (float)Main.rand.Next(-2, 2), 0, new Color(255, 173, 17), 1f);
