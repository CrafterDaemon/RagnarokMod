...
namespace RagnarokMod.Projectiles.HealerPro.Other
{
    public class GraspofVoidPro1 : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            {
                int index6 = Dust.NewDust(new Vector2(((Entity) this.Projectile).position.X, ((Entity) this.Projectile).position.Y), ((Entity) this.Projectile).width, ((Entity) this.Projectile).height, 173, 0.0f, 0.0f, 100, new Color(), 1f);
