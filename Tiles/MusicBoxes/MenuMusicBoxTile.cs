...
using RagnarokMod.Items.Placeables.MusicBoxes;
...
namespace RagnarokMod.Tiles.MusicBoxes
{
    public class MenuMusicBoxTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new(191, 142, 111), CreateMapEntryName());
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            localPlayer.cursorItemIconID = ModContent.ItemType<MenuMusicBox>();
        }
